...
from unifolm_vla.rlds_dataloader.datasets.rlds.oxe.utils.droid_utils import droid_baseact_transform, droid_finetuning_transform
from unifolm_vla.rlds_dataloader.datasets.rlds.utils.data_utils import (
...
def fmb_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    ...
    trajectory["observation"]["proprio"] = tf.concat(
        (
            trajectory["observation"]["action_normalization_maske"],
...
def unitree_g1_ee_6d_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    
    trajectory["observation"]["state"] = trajectory["observation"]["ee_state_6d"]
    trajectory["action"] = trajectory["ee_action_6d"]
    return trajectory

def unitree_g1_joint_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    ### Unitree G1 finetuning datasets、
    "g1_stack_block": unitree_g1_ee_6d_dataset_transform, 
    "g1_pack_pencilbox": unitree_g1_ee_6d_dataset_transform, 
    "g1_bag_insert": unitree_g1_ee_6d_dataset_transform,
    "g1_pour_medicine": unitree_g1_ee_6d_dataset_transform,
    "g1_pack_pingpong": unitree_g1_ee_6d_dataset_transform,
    "g1_wipe_table": unitree_g1_ee_6d_dataset_transform,
    "g1_erase_board": unitree_g1_ee_6d_dataset_transform,
    "g1_organize_tools": unitree_g1_ee_6d_dataset_transform,
    "g1_clean_table": unitree_g1_ee_6d_dataset_transform,
