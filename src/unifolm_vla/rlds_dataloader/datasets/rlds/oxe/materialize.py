...
from unifolm_vla.training.trainer_utils.overwatch import initialize_overwatch
from unifolm_vla.rlds_dataloader.datasets.rlds.oxe.configs import OXE_DATASET_CONFIGS, ActionEncoding
from unifolm_vla.rlds_dataloader.datasets.rlds.oxe.transforms import OXE_STANDARDIZATION_TRANSFORMS
from unifolm_vla.rlds_dataloader.datasets.rlds.utils.data_utils import NormalizationType
...
def make_oxe_dataset_kwargs(
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.JOINT_G1:
        dataset_kwargs["absolute_action_mask"] = [True] * 19
        dataset_kwargs["action_normalization_mask"] = [True] * 19
    elif dataset_kwargs["action_encoding"] is ActionEncoding.EE_R6_G1:
        dataset_kwargs["absolute_action_mask"] = [True] * 23
        dataset_kwargs["action_normalization_mask"] = [True] * 23
    elif dataset_kwargs["action_encoding"] is ActionEncoding.JOINT_G2:
