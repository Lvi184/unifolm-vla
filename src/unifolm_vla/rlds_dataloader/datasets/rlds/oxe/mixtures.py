...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    # === Bridge V2  fractal libero dataset ===
    ...
    "test": [
        ("berkeley_autolab_ur5", 1.0),                                    # Version of Bridge V2 in Open-X GCP Bucket
    ...
    "custom_train_v2": [
        ("fractal20220817_data", 0.54087122203),                # Google RT-1 Robot Data (Large-Scale)
        ("kuka", 0.8341046294),
        ("bridge_orig", 1.5),                                   # Original Version of Bridge V2 from Project Website
       # ("taco_play", 2.0),
        ("jaco_play", 1.0),
        ("berkeley_cable_routing", 1.0),
        ("roboturk", 2.0),
    ...
    # === Unitree Fine-Tuning Datasets ===
    # multiple datasets
    "Unitree_all_task": [
        ("g1_stack_block", 1.20),  
        ("g1_pack_pencilbox", 3.50),  
        ("g1_wipe_table", 8.96),
        ("g1_erase_board", 5.26),
        ("g1_bag_insert", 4.85),
        ("g1_pour_medicine", 4.50),  
        ("g1_pack_pingpong", 4.16),
        ("g1_organize_tools", 3.71), 
        ("g1_clean_table", 2.46),
        ("g1_prepare_fruit", 5.29),  
        ("g1_dual_clean_table", 3.47),
        ("g1_fold_towel", 1.00),  
    ],
    # single dataset
    "g1_stack_block":[
