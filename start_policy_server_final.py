...
Uses the updated unifolm_openpi_policy.py with dimension conversion.
"""
import sys
import logging
import traceback
...
# Load policy
logger.info("=" * 60)
logger.info(" UnifoLM-VLA Policy Server (FINAL - with dimension conversion)")
logger.info("=" * 60)
...
import time  # Import at top for the handler
